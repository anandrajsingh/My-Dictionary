...
import android.example.mydictionary.Models.Phonetics;
import android.example.mydictionary.R;
import android.example.mydictionary.ViewHolders.PhoneticViewHolder;
...
public class PhoneticsAdapter extends RecyclerView.Adapter<PhoneticViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PhoneticViewHolder holder, int position) {
        holder.textViewPhonetic.setText(phoneticsList.get(position).getText());
